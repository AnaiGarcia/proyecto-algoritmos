...
$stmt = $dbh->query("SELECT * FROM usuario u inner join persona p on p.id = u.persona_id where u.activo = 1 ");
...
<table class="items" width="100%" style="border-collapse: collapse; font-size: 12px;" cellpadding="8">
            <thead>
                <tr>
                    ...
                    <td style="font-weight: bold" width="12%">Correo</td>
                    <td style="font-weight: bold" width="12%">Rol</td>
                </tr>
            </thead>
            <tbody>
            ';
foreach ($usuarios as $index => $usuario) {
    $for .= '<tr>
                ...
                <td style="font-weight: bold" width="12%">' . $usuario['correo'] . '</td>
                <td style="font-weight: bold" width="12%">' . $usuario['rol'] . '</td>
            </tr>';
}
$for .= '</tbody>
        </table>
